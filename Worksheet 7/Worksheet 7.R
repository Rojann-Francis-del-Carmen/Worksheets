...
DataF <- data.frame(Student,PreTest,PostTest)
DataF
...
Inorder <- sort(DepartmentofAgriculture, decreasing = FALSE)
Inorder
...
#and their individual state of origin is specified by a character vector of state 
#mnemonics as:
...
headsub <- subset(head, select = "Survived")
headsub
...
library("readxl")
DATA <- read_excel("/cloud/project/Worksheet 7/Breast_Cancer.xlsx")
DATA
...
library(xlsx)
write.xlsx("abalone","/cloud/project/Worksheet 7/abalone.xlsx")
